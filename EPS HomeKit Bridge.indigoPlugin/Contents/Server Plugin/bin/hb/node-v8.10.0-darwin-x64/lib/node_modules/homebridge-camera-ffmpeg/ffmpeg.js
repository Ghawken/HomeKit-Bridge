...
function FFMPEG(hap, cameraConfig, log, videoProcessor) {
  ...
  this.audiosource = ffmpegOpt.audioSource;
  ...
  let options = {
    ...
    audio: {
      ...
      codecs: [
///      {
//         type: "AAC-eld", // Audio Codec
 //         samplerate: 16 //, 24, 48] //KHz
  //      },
          {
              type: "OPUS",
              samplerate: 24
  ...
  if (sessionID) {
    ...
    if (requestType == "start") {
      ...
      if (sessionInfo) {
        ...
        var ffmpegAudiocommand = this.audiosource || '';
        ...
        if (videoInfo) {
          ...
          if (expectedFPS < fps) {
           ...
           if (LANWAN !='None'  && ffmpegAudiocommand != '' ) {
                if (vbitrate < 700) {
                    ffmpegCommand += LANWAN.charAt(1);
                    ffmpegAudiocommand += LANWAN.charAt(1);
                    ...
                    ffmpegAudiocommand +=  LANWAN.charAt(0);
...
// if audiocommand add it seperately
        if (ffmpegAudiocommand != ''){
        // in this case BlueIris stream add stream
            ffmpegCommand =  '-thread_queue_size 512 -probesize 32'+' '+ ffmpegCommand;

            ffmpegCommand += ' -thread_queue_size 8096 -vn -re' +' '+ffmpegAudiocommand;
        }
        ...
        // change mapping to seperate file if audiocommand different
        if (ffmpegAudiocommand !=''){
          // in this case BlueIris stream add stream
